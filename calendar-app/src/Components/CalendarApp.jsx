...
const CalendarApp = () => {
  ...
  const handleDeletingEvent = (eventId)=>{
    ...
    <div className='calendar-app'>
      <div className="calendar">
        ...
        <div className="days">
          ...
          {[...Array(daysInMonth).keys()].map((day)=>(<span key={day+1} className={day + 1 === currentDate.getDate() && currentMonth === currentDate.getMonth() 
          && currentYear === currentDate.getFullYear() ? 'current-day' : ""} onClick={()=> handleDayClick(day + 1)}>{day+1}</span>))}
        </div>
      </div>
        ...
        {events.map((event, index)=>(
          <div className="event" key={index}>
            ...
            <div className="event-buttons">
              ...
              <i className="bx bxs-message-alt-x" onClick={()=> handleDeletingEvent(event.id)}></i>
            </div>
          </div>
        ))}
      </div>
